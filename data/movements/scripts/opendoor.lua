...
function onStepIn(creature, item, position, fromPosition)
	...
	if creature:getCondition(CONDITION_SAFFARI) ~= nil then
		...
		if creature:getItemCount(26685) >= 1 then
			creature:removeItem(26685, creature:getItemCount(26685))
		end
	end
	if creature:getCondition(CONDITION_PARK) ~= nil then
		creature:removeCondition(CONDITION_PARK)
		if creature:getItemCount(39132) >= 1 then
			creature:removeItem(39132, creature:getItemCount(39132))
		end
	end
