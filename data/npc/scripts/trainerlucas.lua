			...
			if npcHandler:isFocused(cid) and npcHandler.topic[cid] == 1 then
				...
				if not monster then
					if pokemons[duelStatus] then
						...
						selfSay('Wow, ' .. player:getName() .. "! Voce e realmente muito forte, creio que pode ser um lider de ginasio algum dia, ou ate mesmo, campeao da liga! Eu quero que fique com um Alolan Marowak, eles sao naturais de uma regiao distante.", cid)
