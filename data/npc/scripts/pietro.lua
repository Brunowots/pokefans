			...
			if npcHandler:isFocused(cid) and npcHandler.topic[cid] == 1 then
				...
				if not monster then
					if pokemons[duelStatus] then
						...
						selfSay('Incrivel, ' .. player:getName() .. "! Seu espirito de batalha e mesmo incrivel, espero poder batalhar com voce novamente em breve. Toma, fique com este pokemon para lembrar do nosso duelo.", cid)
