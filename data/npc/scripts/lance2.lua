			...
			if npcHandler:isFocused(cid) and npcHandler.topic[cid] == 1 then
				...
				if not monster then
					if pokemons[duelStatus] then
						...
						local health = monster:getTotalHealth() * 15
						...
						selfSay('Uau, ' .. player:getName() .. "! Voce me derrotou mesmo, parabens por sua vitoria.", cid)
						Player(cid):teleportTo(Position(247, 870, 0))
						npcHandler:releaseFocus(cid)
					end
				end
