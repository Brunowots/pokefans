...
local function doFire(fromposition, creature, target)
	...
	fromposition:sendMagicEffect(922)
	doSendDistanceShoot(fromposition, Creature(target):getPosition(), 100)
	doTargetCombatHealth(creature.uid, target.uid, COMBAT_FIREDAMAGE, damage, damage, 922)
end
...
function onCastSpell(creature, variant)
	...
	creature:getPosition():sendMagicEffect(921)
	return true
end