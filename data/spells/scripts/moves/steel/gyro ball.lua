...
function onCastSpell(creature, variant)
	local damage = creature:getTotalSpeed() - 100
	for i = 0, 1 do
		...
		addEvent(doAreaCombatHealth, i * 400, creature.uid, COMBAT_STEELDAMAGE, creature:getPosition(), area, damage, damage, 0, COMBAT_PHYSICALDAMAGE)
	end
	return true
end
