...
function onCastSpell(creature, variant)
	...
	for i = 1, 100 do
		...
		addEvent(doSendDistanceShoot, i * 10, creature:getPosition(), Position(topos), 127)
		addEvent(doSendDistanceShoot, 500 + (i * 30), Position(topos), Position(pos), 127)
		Position(pos):getNextPosition(1)
		Position(pos):getNextPosition(2)
		addEvent(doSendMagicEffect, 1250 + (i * 30), Position(pos), 760)
	end
