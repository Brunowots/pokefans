...
function onTargetCreature(creature, target)
	...
	doSendDistanceShoot(creature:getPosition(), target:getPosition(), 195)
	target:getPosition():sendMagicEffect(46)
...
function onCastSpell(creature, variant)
	...
	doAreaCombatHealth(creature.uid, COMBAT_GRASSDAMAGE, creature:getPosition(), area, damage, damage, 0, COMBAT_PHYSICALDAMAGE)
	return true
end