...
function onCastSpell(creature, variant)
	...
	doTargetCombatHealth(creature.uid, target.uid, combat, -damage, -damage, 0, defenseType)
	doTargetCombatHealth(0, creature.uid, COMBAT_HEALING, damage, damage, healingEffect)
