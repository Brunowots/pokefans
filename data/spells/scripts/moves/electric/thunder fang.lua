...
function onTargetCreature(creature, target)
	...
	doTargetCombatHealth(creature.uid, target.uid, COMBAT_ELECTRICDAMAGE, damage, damage, 0, COMBAT_PHYSICALDAMAGE)
	local pos = target:getPosition()
	pos.x = pos.x + 1
	pos.y = pos.y + 1
	pos:sendMagicEffect(997)
...
function onCastSpell(creature, variant)
	...
	creature:getPosition():sendMagicEffect(877)
