...
function onTargetCreature(creature, target)
	...
	addEvent(doSendMagicEffect, 150, creature:getPosition(), 567)
	addEvent(doTargetCombatHealth, 200, creature.uid, target.uid, COMBAT_ELECTRICDAMAGE, damage, damage, 538)
end
