function onSay(player, words, param)
	...
	local form = param
	if ball:getSpecialAttribute("pokeName") ~= "Deoxys" then player:sendTextMessage(MESSAGE_STATUS_CONSOLE_BLUE, "Voce so pode mudar a forma de um Deoxys.") return false end
	if ball ~= 0 then
